...
import { LayoutDashboard, Package, Tags, Settings, LogOut, Users, Truck, Receipt, ShoppingBasket } from "lucide-react"
    ...
    <div className="flex bg-black min-h-screen">
      <aside className="w-64 bg-zinc-950 border-r border-white/5 hidden md:flex flex-col">
        ...
        <nav className="flex-1 py-6 space-y-1 px-3">
           ...
           <Link href="/admin/pdv" className="flex items-center gap-3 px-3 py-3 text-gray-300 hover:bg-white/5 hover:text-white rounded-sm transition-colors font-medium text-sm">
             <ShoppingBasket className="w-5 h-5 text-gray-400" /> PDV
           </Link>
